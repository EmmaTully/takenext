...
export default function PrivacyPage() {
  const privacyPath = path.join(process.cwd(), "TakeNext Privacy Policy - Final.txt");
      ...
      <div className="max-w-4xl mx-auto space-y-10 px-6 pt-32 pb-16">
        <header className="space-y-3">
          ...
          <h1 className="text-4xl md:text-5xl font-bold">
            TakeNext — Privacy Policy
          </h1>
          <p className="text-sm text-gray-400">Last updated: November 20, 2025</p>
        </header>
